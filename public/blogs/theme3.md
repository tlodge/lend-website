...
- Patronising content
 ...
 User context is key and a person's own experiences will strongly shape how they respond to a narrative.  One LEAP member, whilst watching a video narrative, had a strong reaction to a 'serving hatch' at a cafe as it represented *'...everything I dreaded about joining a support group - serving hatch, cup of tea, elderly lady'*.  In another instance a participant found that a narrative was *'relevant'*, but with *'no explanation as to why he (was) immediately told (he) needed a care home'*.  

In the first case, there is clear frustration at the portrayal of dementia as a stereotype that does not reflect her own experience. In the second, the question of whether a partner should move into a care home strongly resonates, but is addressed only briefly within a broader narrative, which makes the moment feel trivialised despite its significance.

Although we cannot ever expect to perfectly match a narrative to a user's own experiences, given that mismatches can be harmful, we discussed the importance of ensuring approaches to mitigate and address harms are central to intervention design.

## Lowering the risk of distressing narratives

What options are available to reduce the distressing effects of a narrative?  We identified **five** promising areas.  Four of them focus on preventing the delivery of a potentially distressing narrative, the fifth may provide support if a narrative causes distress.  
